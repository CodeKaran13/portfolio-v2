...
const EngineBadge = ({ engine, color }) => (
  <span style={{
...
const MediaPlaceholder = ({ codename }) => (
  <div style={{
    position: 'relative',
    ...
    <svg width="100%" height="100%" style={{ position: 'absolute', inset: 0 }} fill="none">
      {[['12,8','8,8','8,20'],['calc(100% - 12px),8','calc(100% - 8px),8','calc(100% - 8px),20'],
    ...
    >
      ...
      <div>
        <h3 style={{
          ...
          fontSize: 20, color: 'var(--color-text)', marginBottom: 4,
        ...
        {project.bullets.map((b, i) => (
          <li key={i} style={{ display: 'flex', gap: 10, alignItems: 'flex-start' }}>
            <span style={{
              ...
              color: 'var(--color-tick)', flexShrink: 0, marginTop: 2,
              opacity: 0.7,
            }}>›</span>
