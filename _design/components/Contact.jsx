...
{
  label: 'Email',
  value: 'knandkar007@gmail.com',
  href: 'mailto:knandkar007@gmail.com',
  hud: 'PRIMARY'
},
{
  label: 'LinkedIn',
  value: 'linkedin.com/in/karannandkar',
  href: 'https://linkedin.com/in/karannandkar/',
  hud: 'PROFILE'
},
{
  label: 'GitHub',
  value: 'github.com/CodeKaran13',
  href: 'https://github.com/CodeKaran13',
  hud: 'CODE'
},
{
  label: 'Phone',
  value: '+91 77100 37151',
  href: 'tel:+917710037151',
  hud: 'MOBILE'
}];
      ...
      gap: 48, alignItems: 'start'
        ...
        <div>
          ...
          background: 'var(--color-surface)'
            ...
            <p style={{ fontSize: 14, color: 'var(--color-text-dim)', lineHeight: 1.7, fontStyle: 'italic' }}>Learning and Developing systems in Unreal Engine.
